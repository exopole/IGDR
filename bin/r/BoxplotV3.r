...
boxplot(A$Sensibility, B$Sensibility,C$Sensibility,D$Sensibility,E$Sensibility, F$Sensibility,G$Sensibility,H$Sensibility, col=mypalette1,ylab="cutoff value distribution", xlab="Sensibility", ylim=c(0.95,0.965), notch=T, main = "evolve of the sensibility")

boxplot(A$Specificity, B$Specificity,C$Specificity,D$Specificity, E$Specificity, F$Specificity,G$Specificity,H$Specificity,col=mypalette1,ylab="cutoff value distribution", xlab="Specificity",ylim=c(0.95,0.965),main = "evolve of the specificity", notch=T)

boxplot(A$Precision, B$Precision,C$Precision,D$Precision,E$Precision, F$Precision,G$Precision,H$Precision, col=mypalette1,ylab="cutoff value distribution", xlab="Precision",ylim=c(0.95,0.965), main = "evolve of the precision",notch= T)

boxplot(A$Accuracy, B$Accuracy,C$Accuracy,D$Accuracy,E$Accuracy, F$Accuracy,G$Accuracy,H$Accuracy, col=mypalette1,ylab="cutoff value distribution", xlab="Accuracy", ylim=c(0.95,0.965), notch= T,main = "evolve of the accuracy")

boxplot(A$cuttof_performance, B$cuttof_performance,C$cuttof_performance,D$cuttof_performance, E$cuttof_performance, F$cuttof_performance, G$cuttof_performance, 	H$cuttof_performance, col=mypalette1,ylab="cutoff value distribution", xlab="performance", ylim=c(0.40,0.60), main = "evolve of the curtoff of performance", notch=T)
