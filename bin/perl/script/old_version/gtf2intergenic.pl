...
%h_transcript = gtf_parse::parseLevelGtfhashKey($infile,'exon', $list, $st, $verbose);
...
gtf2intergenic.pl - Extract fasta sequence from a gtf file

=head1 AUTHOR

Toma Derrien : alexandre.nicaise28@gmail.com
